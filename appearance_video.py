...
def define_poses_brandenburg_gate(dataset):
    N_frames = 30 * 8
    pose_init = np.array([[ 0.99702646,  0.00170214, -0.07704115,  0.00704072], \
    ...
    dy1 = np.linspace(0.01, -0.025, N_frames//2)
    dy2 = np.linspace(-0.025, 0.01, N_frames - N_frames//2)
    dy = np.concatenate((dy1, dy2))

    dz1 = np.linspace(0.05, 0.075, N_frames//2)
    dz2 = np.linspace(0.075, 0.05, N_frames - N_frames//2)
    dz = np.concatenate((dz1, dz2))

    theta_x1 = np.linspace(math.pi/30/4, 0, N_frames//2)
    theta_x2 = np.linspace(0, math.pi/30/4, N_frames - N_frames//2)
    theta_x = np.concatenate((theta_x1, theta_x2))
    theta_y = np.linspace(math.pi/10/4, -math.pi/10/4, N_frames)
...
def define_poses_sacre_coeur(dataset):
    ...
    dy1 = np.linspace(-0.05, 0.5, N_frames//2)    # + down
    dy2 = np.linspace(0.5, -0., N_frames - N_frames//2)
    dy = np.concatenate((dy1, dy2))
