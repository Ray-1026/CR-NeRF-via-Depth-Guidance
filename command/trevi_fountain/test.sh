...
root_dir1="../dataset/trevi_fountain/"
save_dir1=../our_results/trevi_fountain #replace with your own save path
ckpt_path1="../our_results/trevi_fountain/ckpts/train/exp1/last.ckpt"
...
CUDA_VISIBLE_DEVICES=0 python3 eval.py \
  ...
  --chunk 2048 --img_wh 320 240 --encode_a \
  --decoder $decoder \
